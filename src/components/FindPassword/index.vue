<template>
    <div class="password_body">
        <div class="password_email">
            邮箱：<input class="password_text" type="text" v-model="email"><button @touchstart="handleToVerify">发送验证码</button>
        </div>
        <div>
            新密码：<input class="password_text" type="password" v-model="password">
        </div>
        <div>
            验证码：<input class="password_text" type="text" v-model="verify">
        </div>
        <div class="password_btn">
            <input @touchstart="handleToPassword" type="button" value="修改">
        </div>
...
.password_body .password_btn input{ width:100%; height:100%; background:#e54847; border-radius: 3px; border:none; display: block; color:white; font-size: 20px;}
...
.password_body .password_email button{position: absolute;right: 10px;height:30px;border-radius: 3px; border:none; background:#fff;}
</style>